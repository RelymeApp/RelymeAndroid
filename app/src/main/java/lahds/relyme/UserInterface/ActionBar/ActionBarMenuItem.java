...
import lahds.relyme.UserInterface.Components.ActionBarPopupWindow;
...
public class ActionBarMenuItem extends FrameLayout {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        if (icon != 0) {
            ...
            if (!AndroidUtilities.isRTL()) {
                textView.setCompoundDrawablesWithIntrinsicBounds(getContext().getDrawable(icon), null, null, null);
            } else {
