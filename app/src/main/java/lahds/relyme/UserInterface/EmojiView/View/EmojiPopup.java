...
import lahds.relyme.UserInterface.EmojiView.Utils.EmojiResultReceiver;
...
public final class EmojiPopup implements EmojiResultReceiver.Receiver, PopupInterface {
    ...
    public EmojiPopup(final EmojiBase content) {
        ...
        content.setBackgroundColor(EmojiManager.getEmojiViewTheme().getBackgroundColor());
    ...
    public void toggle() {
        EmojiManager.setUsingPopupWindow(true);
