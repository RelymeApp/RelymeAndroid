...
import lahds.relyme.UserInterface.EmojiView.Adapters.FooterIconsAdapter;
...
class FooterView extends EmojiLayout {
    ...
    private void init() {
        ...
        DrawableCompat.setTint(DrawableCompat.wrap(back), EmojiManager.getEmojiViewTheme().getFooterItemColor());
        ...
        backSpace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //if (pager.getEditText()!=null) EmojiUtils.backspace(pager.getEditText());
        ...
        if (Left != -1) {
            ...
            DrawableCompat.setTint(DrawableCompat.wrap(leftIconDr), EmojiManager.getEmojiViewTheme().getFooterItemColor());
        ...
        this.setBackgroundColor(EmojiManager.getEmojiViewTheme().getFooterBackgroundColor());
